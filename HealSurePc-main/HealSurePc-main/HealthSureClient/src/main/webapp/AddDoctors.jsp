...
<div class="form-container">
    ...
    <h:form>
        ...
        <div class="form-group">
            ...
            <styleClass="form-control" style="100px"/>
            <small style="color: #888; font-size: 12px;">Format: MH/2023/12345/P</small>
        </div>
        ...
        <div class="form-group">
            ...
            <h:selectOneMenu id="type" value="#{doctorsController.doctor.doctorType}">
